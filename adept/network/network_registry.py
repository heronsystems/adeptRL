...
from adept.network.net1d.submodule_1d import SubModule
...
class NetworkRegistry:
    def __init__(self):
        ...
        from adept.network.net1d.linear import Linear
        from adept.network.net1d.lstm import LSTM
        net_1d_cls_by_name = {
        ...
        from adept.network.net3d.four_conv import FourConv
        net_3d_cls_by_name = {
