...
from adept.actor import DQNReplayActor
from adept.exp import ExperienceReplay
from adept.learner import DQNReplayLearner
from .base.agent_module import AgentModule


class DQNReplay(AgentModule):
    args = {
    ...
    def _exp_spec(cls, exp_len, batch_sz, obs_space, act_space, internal_space):
        return DQNReplayActor._exp_spec(
            exp_len, batch_sz, obs_space, act_space, internal_space
        )

    @staticmethod
    def output_space(action_space):
        return DQNReplayActor.output_space(action_space)
